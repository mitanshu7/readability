...
# Find accuracy
text_svm_accuracy = embed_svm.score(test_df["text_embedding"].tolist(), test_df["level"])
...
train_df["text_embedding_mrl"] = train_df["text_embedding"].apply(lambda x: x[:len(x)//2])
test_df["text_embedding_mrl"] = test_df["text_embedding"].apply(lambda x: x[:len(x)//2])
...
# Find accuracy
text_svm_accuracy = embed_svm.score(test_df["text_embedding_mrl"].tolist(), test_df["level"])
...
# Find accuracy
text_svm_accuracy = embed_svm.score(test_df_umap["text_embedding_umap"].tolist(), test_df_umap["level"])
